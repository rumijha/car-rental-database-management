...
--------------------------------------------------------
  ...
  USING INDEX PCTFREE 10 INITRANS 20 MAXTRANS 255 
  TABLESPACE "DATA"  ENABLE;
  ALTER TABLE "ADMIN"."SUPPORT" ADD CONSTRAINT "STATUS_CHECK" CHECK (status in ('IN PROCESS', 'COMPLETED', 'PENDING')) ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "ADMIN"."PAYMENTS" ADD CONSTRAINT "STATUS_CHECK1" CHECK (status in ('IN PROCESS', 'COMPLETED', 'PENDING')) ENABLE;
...
----------------------------------------------------------
  ...
  CREATE INDEX "ADMIN"."CARS_AT_PICKUP_INDEX" ON "ADMIN"."CARS_AT_PICKUP" ("PICKUP_POINT_ID", "CAR_ID") 
  ...
  CREATE INDEX "ADMIN"."RIDE_TRANSACTION_INDEX" ON "ADMIN"."RIDE_TRANSACTION" ("CARS_AT_PICKUP_ID", "START_TIME", "CAR_ID", "END_TIME") 
  PCTFREE 10 INITRANS 20 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
